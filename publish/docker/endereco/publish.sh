...
dockerfile_path="${repo_root}/src/endereco/Projeto.Moope.Endereco.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/endereco/Projeto.Moope.Endereco.Api/appsettings.json"
...
env_appsettings="${repo_root}/src/endereco/Projeto.Moope.Endereco.Api/appsettings.${environment}.json"
