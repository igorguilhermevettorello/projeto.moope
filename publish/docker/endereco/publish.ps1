...
$dockerfilePath = Join-Path $repoRoot "src\endereco\Projeto.Moope.Endereco.Api\Dockerfile"
$buildContext = $repoRoot
$appsettingsBasePath = Join-Path $repoRoot "src\endereco\Projeto.Moope.Endereco.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "src\endereco\Projeto.Moope.Endereco.Api\appsettings.$environment.json"
