...
$dockerfilePath = Join-Path $repoRoot "src\auth\Projeto.Moope.Auth.Api\Dockerfile"
$buildContext = $repoRoot
$appsettingsBasePath = Join-Path $repoRoot "src\auth\Projeto.Moope.Auth.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "src\auth\Projeto.Moope.Auth.Api\appsettings.$environment.json"
