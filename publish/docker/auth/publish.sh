...
dockerfile_path="${repo_root}/src/auth/Projeto.Moope.Auth.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/auth/Projeto.Moope.Auth.Api/appsettings.json"
...
env_appsettings="${repo_root}/src/auth/Projeto.Moope.Auth.Api/appsettings.${environment}.json"
