...
dockerfile_path="${repo_root}/src/comodato/Projeto.Moope.Comodato.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/comodato/Projeto.Moope.Comodato.Api/appsettings.json"
...
env_appsettings="${repo_root}/src/comodato/Projeto.Moope.Comodato.Api/appsettings.${environment}.json"
