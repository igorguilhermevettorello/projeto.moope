...
$appsettingsBasePath = Join-Path $repoRoot "bff\Projeto.Moope.Gateways.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "bff\Projeto.Moope.Gateways.Api\appsettings.$environment.json"
