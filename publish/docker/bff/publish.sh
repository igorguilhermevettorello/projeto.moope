...
dockerfile_path="${repo_root}/bff/Projeto.Moope.Gateways.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/bff/Projeto.Moope.Gateways.Api/appsettings.json"
...
env_appsettings="${repo_root}/bff/Projeto.Moope.Gateways.Api/appsettings.${environment}.json"
