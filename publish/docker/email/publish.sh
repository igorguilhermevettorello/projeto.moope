...
dockerfile_path="${repo_root}/src/email/Projeto.Moope.Email.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/email/Projeto.Moope.Email.Api/appsettings.json"
...
env_appsettings="${repo_root}/src/email/Projeto.Moope.Email.Api/appsettings.${environment}.json"
