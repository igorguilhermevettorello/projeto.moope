...
$dockerfilePath = Join-Path $repoRoot "src\email\Projeto.Moope.Email.Api\Dockerfile"
$buildContext = $repoRoot
$appsettingsBasePath = Join-Path $repoRoot "src\email\Projeto.Moope.Email.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "src\email\Projeto.Moope.Email.Api\appsettings.$environment.json"
