...
$dockerfilePath = Join-Path $repoRoot "src\pedido\Projeto.Moope.Pedido.Api\Dockerfile"
$buildContext = $repoRoot
$appsettingsBasePath = Join-Path $repoRoot "src\pedido\Projeto.Moope.Pedido.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "src\pedido\Projeto.Moope.Pedido.Api\appsettings.$environment.json"
