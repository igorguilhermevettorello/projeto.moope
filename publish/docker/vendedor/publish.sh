...
dockerfile_path="${repo_root}/src/vendedor/Projeto.Moope.Vendedor.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/vendedor/Projeto.Moope.Vendedor.Api/appsettings.json"
...
env_appsettings="${repo_root}/src/vendedor/Projeto.Moope.Vendedor.Api/appsettings.${environment}.json"
