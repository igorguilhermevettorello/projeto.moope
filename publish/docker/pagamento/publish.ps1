...
$dockerfilePath = Join-Path $repoRoot "src\pagamento\Projeto.Moope.Pagamento.Api\Dockerfile"
$buildContext = $repoRoot
$appsettingsBasePath = Join-Path $repoRoot "src\pagamento\Projeto.Moope.Pagamento.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "src\pagamento\Projeto.Moope.Pagamento.Api\appsettings.$environment.json"
