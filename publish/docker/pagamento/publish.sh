...
dockerfile_path="${repo_root}/src/pagamento/Projeto.Moope.Pagamento.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/pagamento/Projeto.Moope.Pagamento.Api/appsettings.json"
...
env_appsettings="${repo_root}/src/pagamento/Projeto.Moope.Pagamento.Api/appsettings.${environment}.json"
