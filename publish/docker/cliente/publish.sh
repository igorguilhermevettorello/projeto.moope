...
dockerfile_path="${repo_root}/src/cliente/Projeto.Moope.Cliente.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/cliente/Projeto.Moope.Cliente.Api/appsettings.json"
...
env_appsettings="${repo_root}/src/cliente/Projeto.Moope.Cliente.Api/appsettings.${environment}.json"
