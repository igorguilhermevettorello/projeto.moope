...
$dockerfilePath = Join-Path $repoRoot "src\cliente\Projeto.Moope.Cliente.Api\Dockerfile"
$buildContext = $repoRoot
$appsettingsBasePath = Join-Path $repoRoot "src\cliente\Projeto.Moope.Cliente.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "src\cliente\Projeto.Moope.Cliente.Api\appsettings.$environment.json"
