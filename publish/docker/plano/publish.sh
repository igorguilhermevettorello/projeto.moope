...
dockerfile_path="${repo_root}/src/plano/Projeto.Moope.Plano.Api/Dockerfile"
build_context="${repo_root}"
appsettings_base_path="${repo_root}/src/plano/Projeto.Moope.Plano.Api/appsettings.json"
