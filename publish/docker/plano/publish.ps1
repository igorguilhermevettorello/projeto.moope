...
$dockerfilePath = Join-Path $repoRoot "src\plano\Projeto.Moope.Plano.Api\Dockerfile"
$buildContext = $repoRoot
$appsettingsBasePath = Join-Path $repoRoot "src\plano\Projeto.Moope.Plano.Api\appsettings.json"
$appsettingsEnvPath = Join-Path $repoRoot "src\plano\Projeto.Moope.Plano.Api\appsettings.$environment.json"
